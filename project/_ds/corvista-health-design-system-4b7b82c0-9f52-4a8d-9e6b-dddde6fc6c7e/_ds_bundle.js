/* @ds-bundle: {"format":3,"namespace":"CorVistaHealthDesignSystem_4b7b82","components":[],"sourceHashes":{"slides/deck-stage.js":"d8d952171670","slides/slide-scale.js":"68d731293e3a"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.CorVistaHealthDesignSystem_4b7b82 = window.CorVistaHealthDesignSystem_4b7b82 || {});
...
// slides/slide-scale.js
try { (() => {
// slide-scale.js — wrap a 1920x1080 slide and scale to fit the viewport
(function () {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "slides/slide-scale.js", error: String((e && e.message) || e) }); }
