...
// ============================================================
// Technology → disease sub-pages (CAD · PH · PCWP)
// One shared template, three content objects.
// ============================================================
...
function DiseasePage({ d, activeKey }) {
  return (
    <div className="page-fade" data-screen-label={d.screenLabel} data-page={d.slug}>
      ...
      {/* What CorVista detects — performance */}
      <Section dark>
...
function TechCadPage() { return <DiseasePage d={CV_DISEASES.cad} activeKey="cad" />; }
function TechPhPage() { return <DiseasePage d={CV_DISEASES.ph} activeKey="ph" />; }
function TechPcwpPage() { return <DiseasePage d={CV_DISEASES.pcwp} activeKey="pcwp" />; }

Object.assign(window, { TechCadPage, TechPhPage, TechPcwpPage });
