/* global React, Eyebrow, Section, SectionHeader, ImgPh, Btn, Stat, NavA, navTo */
...
function CliniciansPage() {
  return (
    <div className="page-fade" data-screen-label="03 Clinicians" data-page="clinicians">
      ...
      <Section>
        <SectionHeader eyebrow="The workflow" title="Fits the day you already work." />
        <div className="row row-2" style={{ gridTemplateColumns: '1fr 1.5fr', gap: 64 }}>
          ...
          <div className="row" style={{ gap: 0 }}>
            {[
              ...
              { n: '03', t: 'Apply the sensor', c: 'A medical assistant places the single-use sensor. The acquisition takes 220 seconds at rest.' },
              { n: '04', t: 'Review the report', c: 'A physician-reviewed report drops into your portal — typically within minutes — with disease probability scores and recommended next steps.' },
            ].map(s => (
      ...
      <Section>
        ...
        <div className="row row-4">
          {[
            ...
            { t: 'Hardware', c: 'Single-use sensors ship in 48 hours. The tablet is provided. No capex.' },
            { t: 'Support', c: 'Dedicated clinical account manager. 24/7 reading service for STAT reads.' },
          ].map(s => (
...
Object.assign(window, { CliniciansPage });
