...
const CV_DISEASES = {
  cad: {
    ...
    perfNote: 'Functionally significant obstructive coronary disease in stable, symptomatic patients. A >99% rule-out lets clinicians defer or avoid unecessary downstream testing with confidence.',
    workflow: [
      ...
      { n: '02', t: 'In minutes', c: 'A CAD score returns to the portal, raising or lowering pre-test probability.' },
      { n: '03', t: 'Informing the right next step', c: 'Rule out without a downstream referral, or send the right patients to the cath lab with sharper indication.' },
    ],
    stats: [
  ...
  ph: {
    ...
    problemLead: 'Breathlessness is one of the most common — and most ambiguous — presentations in medicine. Making PH difficult to identify.',
    problems: [
  ...
  pcwp: {
    ...
    lead: 'Elevated pulmonary capillary wedge pressure is the hemodynamic signature of heart failure — but confirming it means an echo wait or an invasive measurement. CorVista estimates elevated wedge pressure in-office, from a resting signal.',
    problemTitle: 'Heart failure hides in plain sight.',
    problemLead: 'Heart failure builds quietly behind breathlessness and fatigue. By the time it declares itself, it is often a hospitalization.',
    problems: [
      { t: 'Roughly half of HF goes undiagnosed', c: 'Heart failure is easy to miss on front-line exam and easy to mistake for deconditioning or age — in both preserved and reduced ejection fraction.' },
    ...
    perfNote: 'Increased pulmonary capillary wedge pressure, consistent with heart failure with both preserved or reduced ejection fraction. Delivered at the front-line of care.',
    workflow: [
      ...
      { n: '02', t: 'A decision in-office', c: 'A PCWP score gives the clinician hemodynamic insight without waiting weeks for an echo.' },
