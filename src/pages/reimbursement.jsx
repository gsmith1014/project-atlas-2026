    ...
    <div className="page-fade" data-screen-label="Reimbursement" data-page="reimbursement">
      ...
      <Section>
        ...
        <p style={{ marginTop: -16, marginBottom: 32, fontSize: 15, color: 'var(--fg-muted)', lineHeight: 1.6, maxWidth: '72ch' }}>
          Select the patient's relevant indication(s) to view commonly associated ICD-10 diagnosis codes drawn from the CorVista Clinical Dossier (Appendix A). The CorVista System evaluates all three conditions in a single test.
        </p>
